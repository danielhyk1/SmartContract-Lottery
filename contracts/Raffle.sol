...
//chainlink oracle -> and chainlink keeper
...
contract Raffle is VRFConsumerBaseV2, AutomationCompatible {
    ...
    /**
     * @dev This is the function that the Chainlink Keeper nodes call when they look for the upkeepneeded to be true
     * 1. Our time interval passed
